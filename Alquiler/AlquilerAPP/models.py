...
class User(AbstractUser):
    ...
    # Relacionar `related_name` para evitar conflictos con los campos `groups` y `user_permissions` heredados
    groups = models.ManyToManyField(
        'auth.Group',
        related_name='custom_user_set',  # Cambiar el nombre de acceso inverso
        blank=True,
    ...
    user_permissions = models.ManyToManyField(
        'auth.Permission',
        related_name='custom_user_permissions_set',  # Cambiar el nombre de acceso inverso
        blank=True,
...
class Propiedades(models.Model):
    ...
    imagen = models.ImageField(upload_to='img/propiedades/', null=False, blank=False, default='img/propiedades/default_image.jpg')
